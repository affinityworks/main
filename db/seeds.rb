...
admin = Person.create(family_name: 'Admin', given_name: 'Test', gender: 'Other', password: 'password', admin: true)
...
member1 = Person.create(family_name: 'Member', given_name: 'Test', gender: 'Other',  password: 'password')
...
member2 = Person.create(family_name: 'member', given_name: 'Test', gender: 'Other',  password: 'password')
...
organizer = Person.create(family_name: 'Organizer', given_name: 'Local', gender: 'Other',  password: 'password')
...
norganizer = Person.create(family_name: 'Organizer', given_name: 'National', gender: 'Other',  password: 'password')
